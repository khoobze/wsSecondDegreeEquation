...
public class Quadsol extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("sol_eq_servlet.jsp").include(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request != null) {
            ...
            try {
                var = rh.extractVariables(request);
            } catch (NumberFormatException e) {
                request.setAttribute("response", "<p class='error'>Vieullez réentrer vos données</p>");
